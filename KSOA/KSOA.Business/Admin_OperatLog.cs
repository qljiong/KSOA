...
namespace KSOA.DAL
{
	...
	public partial class Admin_OperatLog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Admin_OperatLog"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from Admin_OperatLog");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Admin_OperatLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public KSOA.Model.Admin_OperatLog GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,OperatorID,OperatorName,Module,OperationContent,OpIp,AddTime from Admin_OperatLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			KSOA.Model.Admin_OperatLog model=new KSOA.Model.Admin_OperatLog();
		...
		/// 得到一个对象实体
		/// </summary>
		public KSOA.Model.Admin_OperatLog DataRowToModel(DataRow row)
		{
			KSOA.Model.Admin_OperatLog model=new KSOA.Model.Admin_OperatLog();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,OperatorID,OperatorName,Module,OperationContent,OpIp,AddTime ");
			strSql.Append(" FROM Admin_OperatLog ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,OperatorID,OperatorName,Module,OperationContent,OpIp,AddTime ");
			strSql.Append(" FROM Admin_OperatLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Admin_OperatLog T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Admin_OperatLog";
